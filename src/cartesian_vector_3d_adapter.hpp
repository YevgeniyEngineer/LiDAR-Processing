#ifndef LIDAR_PROCESSING__CARTESIAN_VECTOR_3D_ADAPTER_HPP
#define LIDAR_PROCESSING__CARTESIAN_VECTOR_3D_ADAPTER_HPP
...
#endif // LIDAR_PROCESSING__CARTESIAN_VECTOR_3D_ADAPTER_HPP
